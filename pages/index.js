  ...
  return (
    <div className='bg-white'>
                ...
                <div className='py-6 px-5'>
                  ...
                  <div className='mt-6'>
                    ...
                    <p className='mt-6 text-center text-base font-medium text-gray-500'>
                      Existing customer?
                    <a href='/login' className='text-gray-900'> Sign in </a>
      ...
      <main>
        ...
        <div className='relative pt-10 pb-32 overflow-hidden'>
          <div aria-hidden='true' className='absolute inset-x-0 top-0 h-48 ' />
          <div className='relative'>
            <div className='lg:mx-auto lg:max-w-7xl lg:px-8 lg:grid lg:grid-cols-2 lg:grid-flow-col-dense lg:gap-2'>
              <div className='px-4 max-w-xl mx-auto sm:px-6 lg:py-16 lg:max-w-none lg:mx-0 lg:px-0'>
                <div>
                  <div className='mt-6'>
                    <h2 className='text-8xl font-heading font-bold tracking-tight text-gray-900'>
                      Let your work speak for itself
                    </h2>
                    <p className='mt-4 text-md text-gray-500'>
                      Create experience driven resumes that highlight your
                      capabilities and showcase your talent. Post live resumes
                      that update in real time and get rid of the old PDF resume
                      format.
                    </p>
                    <div className='mt-6'>
                    <Link href='/login'>
              ...
              <div className='mt-12 sm:mt-16 lg:mt-0'>
                <div className='pl-4 -mr-48 sm:pl-6 md:-mr-16 lg:px-0 lg:m-0 lg:relative lg:h-full'>
                  <img
                    ...
                    src='https://firebasestorage.googleapis.com/v0/b/img-upload-6be91.appspot.com/o/images%2F2x.png?alt=media&token=d8388ca3-8cd4-4c91-8cb4-7a207cba96a7'
            ...
            <div className='lg:mx-auto lg:max-w-7xl lg:px-8 lg:grid lg:grid-cols-2 lg:grid-flow-col-dense lg:gap-24'>
              <div className='px-4 max-w-xl mx-auto sm:px-6 lg:py-32 lg:max-w-none lg:mx-0 lg:px-0 lg:col-start-2'>
                <div>
                  ...
                  <div className='mt-6'>
                    <div className='text-8xl font-extrabold tracking-tight text-gray-900'>
                      Better understand your customers
                    </div>
                    <p className='mt-4 text-sm text-gray-500 mr-10'>
                    ...
                    <div className='mt-6'>
                      ...
                      >
                        <a className='inline-flex bg-gradient-to-r from-purple-600 to-indigo-600 bg-origin-border px-4 py-2 border border-transparent text-base font-medium rounded-md shadow-sm text-white hover:from-purple-700 hover:to-indigo-700'>Get started</a>
                      </Link>
                    </div>
                  </div>
                </div>
        ...
        <div className='max-w-7xl mx-auto pt-16 pb-8 px-4 sm:px-6 lg:pt-24 lg:px-8'>
          ...
          <div className='mt-12 border-t border-gray-200 pt-8 md:flex md:items-center md:justify-between lg:mt-16'>
            ...
            <p className='mt-8 text-base text-gray-400 md:mt-0 md:order-1'>
              &copy; 2022 Appwharf SaaS Private Limited. All rights reserved.
            </p>
          </div>
        </div>
      </footer>
